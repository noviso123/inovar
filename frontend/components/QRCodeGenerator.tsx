      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <div className="bg-white rounded-[3.5rem] p-10 border-2 border-slate-100 shadow-sm space-y-8">
          ...
          <div className="mt-6 pt-6 border-t border-slate-100">
            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3">Materiais de Divulgação</p>
            <a
              href="/logo.png"
              download="INOVAR_REFRIGERACAO_LOGO.png"
              className="w-full py-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-black rounded-2xl shadow-xl hover:shadow-2xl transition-all uppercase tracking-widest text-[9px] flex items-center justify-center gap-2 active:scale-95"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
              </svg>
              Baixar Logo (Alta Resolução)
            </a>
            <p className="text-[9px] text-slate-400 text-center mt-2">Ideal para impressão A4, adesivos, carro</p>
          </div>
        </div>
