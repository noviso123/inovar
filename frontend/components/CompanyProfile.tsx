      ...
      <div className="px-0 -mt-12 relative z-20 space-y-4">
        ...
        <div className="bg-white rounded-[2rem] p-6 shadow-xl border border-slate-100">
          ...
          <div className="space-y-3">
            ...
            />
            <label className={`block w-full py-3 text-center rounded-xl font-bold text-xs uppercase cursor-pointer transition-all ${!certPassword ? 'bg-slate-200 text-slate-400 cursor-not-allowed' : 'bg-cyan-600 text-white hover:bg-cyan-700'
              }`}>
