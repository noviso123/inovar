  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans flex justify-center">
      ...
      <div className="w-full max-w-[1600px] bg-slate-50 min-h-screen flex flex-col relative shadow-2xl shadow-slate-200/50 transition-all duration-300">
        ...
        <nav className="fixed bottom-6 left-1/2 -translate-x-1/2 bg-slate-900/95 backdrop-blur-3xl border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)] rounded-[2rem] px-2 sm:px-8 py-2.5 sm:py-3 flex items-center gap-1 sm:gap-6 z-[70] transition-all duration-500 hover:scale-[1.02]">
          {visibleNavItems.map(item => {
            ...
            return (
              ...
              >
                <div className={`p-2 sm:p-3 rounded-2xl transition-all duration-500 ${isActive ? 'bg-cyan-500/20 shadow-[0_0_20px_rgba(34,211,238,0.2)]' : 'hover:bg-white/5'}`}>
