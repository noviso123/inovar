                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-1">
                            ...
                            <input
                                ...
                                className="w-full px-6 py-4 rounded-2xl bg-slate-50 border-2 border-slate-100 focus:border-amber-500 focus:outline-none font-bold text-slate-800 transition-all"
                                placeholder="••••••"
                                disabled={loading}
                            />
                        </div>
