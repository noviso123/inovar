...
export const Profile: React.FC<ProfileProps> = ({ user, onUpdateUser }) => {
  ...
  return (
    <div className="animate-in fade-in duration-500 pb-8">
      ...
      {/* Stats Card */}
      <div className="px-0 -mt-12 relative z-20">
        <div className="bg-white rounded-[2rem] p-6 shadow-xl border border-slate-100 flex justify-between items-center text-center">
          <div className="flex-1 border-r border-slate-100">
            <p className="text-2xl font-black text-slate-800">--</p>
            <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Atendimentos</p>
          </div>
          <div className="flex-1">
            <div className="w-8 h-8 mx-auto bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-xs mb-1">💎</div>
            <p className="text-[10px] text-blue-600 font-black uppercase tracking-widest">Ativo</p>
          </div>
        </div>
      </div>
