        ...
        <div className="animate-in fade-in duration-500 pb-8">
            ...
            <div className="bg-white rounded-[2.5rem] p-8 shadow-xl border border-slate-100 prose prose-slate max-w-none">
                ...
                <p className="text-slate-600 text-sm leading-relaxed">
                    A sua privacidade é importante para nós. É política do Inovar respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site Inovar, e outros sites que possuímos e operamos.
                </p>
